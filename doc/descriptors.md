# Support for Output Descriptors in Flight Core

Since Flight Core v0.17, there is support for Output Descriptors. This is a
...
on Flight's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Flight Core wallets, a convenience function `combo` is
