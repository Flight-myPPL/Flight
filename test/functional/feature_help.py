...
"""Verify that starting Flight with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Flight with -h for help text")
        ...
        self.log.info("Start Flight with -version for version information")
        ...
        self.log.info("Start Flightd with -fakearg to make sure it does not start")
