...
const char * const BITCOIN_CONF_FILENAME = "flight.conf";
const char * const BITCOIN_PID_FILENAME = "flight.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "flight";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/flight";
#else
    // Unix
    return pathRet / ".flight";
#endif
#endif
}
