...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " Flight-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  Flight-tx [options] <hex-tx> [commands]  Update hex-encoded Flight transaction\n" +
            "or:     Flight-tx [options] -create [commands]   Create hex-encoded Flight transaction\n" +
            "\n";
