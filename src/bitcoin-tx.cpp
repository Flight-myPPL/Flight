...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s flight-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flight-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flight transaction") + "\n" +
              "  flight-tx [options] -create [commands]   " + _("Create hex-encoded flight transaction") + "\n" +
              "\n";
